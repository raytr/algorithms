...
func TestSolution(t *testing.T) {
	...
	assert.Equal(t, 6, findCheapestPrice(4, [][]int{{0, 1, 1}, {0, 2, 5}, {1, 2, 1}, {2, 3, 1}}, 0, 3, 1))
	assert.Equal(t, 6, findCheapestPrice(4, [][]int{{0, 1, 1}, {0, 2, 5}, {1, 2, 1}, {2, 3, 1}}, 0, 3, 1))
	...
	assert.Equal(t, 8, findCheapestPrice(6, [][]int{{0, 1, 1}, {1, 2, 1}, {2, 4, 1}, {0, 3, 3}, {3, 4, 4}, {4, 5, 1}}, 0, 5, 2)) // IMPORTANT edge case
}
